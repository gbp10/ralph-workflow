...
1. PRD exists at `ralph/specs/[feature]/requirements.md`
2. `/design-solution` has been run
3. Blueprint exists at `ralph/specs/[feature]/implementation-blueprint.md`
...
```json
{
  ...
  "prd_path": "ralph/specs/feature-name/requirements.md",
  ...
  "knowledge_files": {
    "pre_load": [
      "ralph/knowledge/DATABASE_SCHEMA.md",
      "ralph/knowledge/INFRASTRUCTURE.md"
    ]
  }
}
```
